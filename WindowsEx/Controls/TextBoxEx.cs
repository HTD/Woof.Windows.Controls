...
namespace Woof.WindowsEx.Controls {
    ...
    public class TextBoxEx : TextBox {
        ...
        private static void OnOverridenTextChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => (d as TextBoxEx).SetBaseText((string)e.NewValue);
        ...
        private static void OnLabelChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            if (!String.IsNullOrEmpty((string)e.NewValue)) (d as TextBoxEx).SetLabel((string)e.NewValue);
        }
